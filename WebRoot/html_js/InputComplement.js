...
function charts(row) {
    ...
    if (startDate > endDate) {
        ...
        loadPage('./html/KpiHistoryCharts.jsp?tagName=' + record.tagName + '&st=' + startDate.getTime() + '&et=' + endDate.getTime(), '指标历史曲线')
    }
}
...
function details(row) {
    ...
    if (startDate > endDate) {
        ...
        loadPage('./html/KpiHistoryDetail.jsp?tagName=' + record.tagName + '&st=' + startDate.getTime() + '&et=' + endDate.getTime(), '指标历史明细')
    }

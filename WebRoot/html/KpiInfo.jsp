...
<head>
    ...
    <script type="text/javascript">
        var downloadURI = '<%=request.getContextPath()%>/kpi/KpiInfoDownload.htm';
        var uploadURI = '<%=request.getContextPath()%>/kpi/KpiInfoUpload.htm';
    </script>
    ...
    <script type="text/javascript" src="../dwr/interface/KpiWeightsCalc.js"></script>
    <script type="text/javascript" src="../dwr/interface/ProfessionDao.js"></script>
    <script type="text/javascript" src="../dwr/interface/KpiInfoDao.js"></script>
    <script type="text/javascript" src="../dwr/interface/KpiTypeDao.js"></script>
    <script type="text/javascript" src="../dwr/interface/TagInfoDao.js"></script>

    <script type="text/javascript" src="../html_js/KpiInfo.js"></script>

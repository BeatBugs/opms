...
<head>
    ...
    var uploadURI = '<%=request.getContextPath()%>/duty/DutyTableUpload.htm';
    </script>
    <!-- DWR dependencies -->
    <script type="text/javascript" src="../dwr/interface/DayDutyDao.js"></script>
    <script type="text/javascript" src="../dwr/interface/DutyTableService.js"></script><script type="text/javascript" src="../dwr/interface/UserDao.js"></script>
    <script type="text/javascript" src="../html_js/DutyTable.js"></script>

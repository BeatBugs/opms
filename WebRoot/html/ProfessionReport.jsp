...
<head>
    ...
    <!-- DWR dependencies -->
    <script>
        var downloadURI = '<%=request.getContextPath()%>/professionReport/ProfessionReportDownload.htm';
        var reportId = '<%=reportId%>'
    </script>
    <script type="text/javascript" src="../dwr/interface/ReportConfigDao.js"></script>

    <script type="text/javascript" src="../dwr/interface/ProfessionReportDao.js"></script>
    <script type="text/javascript" src="../html_js/Common.js"></script>
    <script type="text/javascript" src="../html_js/ProfessionReport.js"></script>
</head>
<body>
